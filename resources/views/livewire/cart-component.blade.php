		...
		<div class="container">
			...
			<div class=" main-content-area">
					...
					<ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
							...
							<div class="quantity">
                                ...
                                <p><a href="text-center" wire:click.prevent="switchToSaveToLater('{{ $item->rowId }}')" >Save For Later</a></p>
							</div>
				...
				<div class="summary">
                    ...
                    @if (!Session::has('coupon'))
						...
						<label class="checkbox-field">
							<input name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouponCode"><span>I have coupon code</span>
						</label>
                        {{-- @if ($haveCouponCode == 1) --}}
                        <div class="summary-item">
                            <form action="" wire:submit.prevent="applyCouponCode">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" class="coupon-code" wire:model="couponCode">
                                </p>
                ...
                <div class="wrap-iten-in-cart">
					...
					<ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
							...
							<div class="quantity">
                                ...
                                <p><a href="text-center" wire:click.prevent="moveToCart('{{ $item->rowId }}')" >Move to Cart</a></p>
							</div>
							<div class="delete">
                    ...
                    @else
                    <h3 class="box-title">No items Saved for later</h3>
                    @endif
				</div>
