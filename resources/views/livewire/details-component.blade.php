                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.detail', ['slug' => $p_products->slug]) }}" title="{{ $p_products->name }}">
                                            <figure><img src="{{ asset('assets/images/products') }}/{{ $p_products->image }}" alt="{{ $p_products->name }}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ route('product.detail', ['slug' => $p_products->slug]) }}" title="{{ $p_products->name }}" class="product-name"><span>{{ $p_products->name }}</span></a>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.detail', ['slug' => $r_products->slug]) }}" title="{{ $r_products->name }}">
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.detail', ['slug' => $r_products->slug]) }}" title="{{ $r_products->name }}" class="product-name"><span>{{ $r_products->name }}</span></a>
